...
- **电池供电注意**：使用 5V 升压充电模块供电时，**不要在设备开机运行中插/拔 USB 充电线**，否则充电模块保护电路可能锁定，导致输出中断（LED 微弱闪动，无法重启）。如需充电请先关机，或锁定后断开充电模块输出端等待 3 秒复位
- **OLED 显示卡屏问题**：使用 5V 升压充电模块供电时，偶发 OLED 屏幕定住（语音/电机正常）—— 因电池电压低时升压模块纹波增大，干扰 I2C 总线导致 SSD1306 通信卡死。解决方法：在充电模块 5V 输出端与开发板之间加一个 47μF 电解电容（正极 5V，负极 GND）滤波稳压
